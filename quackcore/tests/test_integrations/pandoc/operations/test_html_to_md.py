...
def test_validate_conversion_html_to_md():
    ...
    with patch('quackcore.integrations.pandoc.operations.html_to_md.fs', fs_mock), \
         patch('quackcore.integrations.pandoc.operations.html_to_md.check_file_size', patched_file_size_check), \
         patch('quackcore.integrations.pandoc.operations.html_to_md.check_conversion_ratio', patched_ratio_check):
        ...
        with patch('quackcore.integrations.pandoc.operations.html_to_md.check_conversion_ratio',
