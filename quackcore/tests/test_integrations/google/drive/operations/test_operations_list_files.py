# quackcore/tests/test_integrations/google/drive/operations/test_operations_list_files.py
"""
...
class TestDriveOperationsListFiles:
    ...
    def test_list_files(self) -> None:
        ...
        with patch(
            "quackcore.integrations.google.drive._operations.list_files.execute_api_request"
        ) as mock_execute:
            mock_execute.return_value = {"files": mock_file_list}

            # Setup mock build_query - correct the import path
            with patch(
                "quackcore.integrations.google.drive._operations.list_files.build_query"
            ) as mock_query:
