...
class TestGoogleDriveServiceFiles:
    ...
    def test_resolve_file_details(self, drive_service, tmp_path: Path) -> None:
        ...
        with patch(
                "quackcore.integrations.google.drive.service.paths_service.resolve_project_path"
        ) as mock_resolve:
            ...
            with patch("quackcore.integrations.google.drive.service.standalone") as mock_fs:
    ...
    def test_resolve_download_path(self, drive_service, tmp_path: Path) -> None:
        ...
        with patch(
                "quackcore.integrations.google.drive.service.paths_service.resolve_project_path") as mock_resolve:
            # Update to return PathResult with string path
            mock_resolve.return_value = PathResult(
                success=True,
