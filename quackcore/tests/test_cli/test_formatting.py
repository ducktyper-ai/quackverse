...
class TestColorize:
    ...
    def test_basic_colorization(self) -> None:
        ...
        with patch("quackcore.cli.formatting.supports_color", return_value=True):
    ...
    def test_without_color_support(self) -> None:
        ...
        with patch("quackcore.cli.formatting.supports_color", return_value=False):
...
class TestPrintFunctions:
    ...
    def test_print_error(self) -> None:
        ...
        with patch("builtins.print") as mock_print:
            with patch("quackcore.cli.formatting.colorize") as mock_colorize:
        ...
        with patch("builtins.print"):
            with patch("quackcore.cli.formatting.colorize"):
...
class TestTable:
    ...
    def test_with_max_width(self) -> None:
        ...
        with patch("quackcore.cli.formatting.get_terminal_size") as mock_get_size:
...
class TestDictToTable:
    ...
    def test_basic_dict_to_table(self) -> None:
        ...
        with patch("quackcore.cli.formatting.table") as mock_table:
