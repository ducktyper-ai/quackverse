...
across different QuackTools, leveraging quackcore's enhanced logging functionality.
"""
...
def setup_tool_logging(tool_name: str, log_level: str = "INFO") -> None:
    ...
    leveraging quackcore's enhanced logging capabilities including
    ...
    # Configure the tool's logger using quackcore's configure_logger
...
def get_logger(tool_name: str) -> logging.Logger:
    ...
    This is a thin wrapper around quackcore.logging.get_logger
    ...
    Returns:
        A Logger instance configured for the tool with quackcore enhancements
    """
...
def log_teaching(logger: Any, message: str, level: str = "INFO") -> None:
    ...
    This is a convenience wrapper around quackcore.logging.config.log_teaching.
