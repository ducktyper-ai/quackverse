# src/quackcore/teaching/github/teaching_service.py
"""GitHub teaching integration service for QuackCore."""
...
class GitHubTeachingIntegration(GitHubTeachingIntegrationProtocol):
    """GitHub teaching integration for educational workflows."""

    def __init__(self, github_integration: GitHubIntegration) -> None:
        """Initialize the GitHub teaching integration.
    ...
    def initialize(self) -> IntegrationResult:
        ...
        return IntegrationResult.success_result(
            message="GitHub teaching integration initialized successfully"
        )

    def is_available(self) -> bool:
        """Check if the GitHub teaching integration is available.
