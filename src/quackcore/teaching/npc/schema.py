# src/quackcore/teaching/npc/schema.py
"""
Schema definitions for the Quackster teaching NPC.

This module defines the core data models for interacting with the teaching NPC,
...
class TeachingNPCInput(BaseModel):
    """
    Input data for a teaching NPC interaction.
...
class TeachingNPCResponse(BaseModel):
    """
    Response data from a teaching NPC interaction.
