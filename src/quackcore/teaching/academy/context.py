...
managing the teaching environment, configuration, and dependencies.
"""
...
class GitHubConfig(BaseModel):
    """GitHub configuration for teaching contexts."""
...
class TeachingConfig(BaseModel):
    """Configuration model for teaching contexts."""
...
class TeachingContext:
    """
    Context for teaching operations.

    This class manages the teaching environment, configuration, and dependencies.
    It serves as the central hub for accessing teaching resources and services.
    """
    ...
    def __init__(
        ...
        logger.info(f"Initialized teaching context for course: {config.course_name}")
    ...
    def ensure_directories(self) -> None:
        ...
        logger.debug(f"Ensured teaching directories exist in {self.base_dir}")
    ...
    def from_config(
        ...
        """
        Create a teaching context from a configuration file.
        ...
        if config_path is None:
            ...
            if not config_path:
                potential_paths = [
                    ...
                    Path.cwd() / "config" / "teaching.yaml",
                    Path.home() / ".config" / "quack" / "teaching.yaml",
                ]
        ...
        if config_path is None:
            raise QuackConfigurationError(
                "No teaching configuration file found. "
        ...
        try:
            ...
            raise QuackConfigurationError(
                f"Failed to load teaching configuration from {config_path}: {str(e)}",
    ...
    def create_default(
        ...
        """
        Create a teaching context with default configuration.
