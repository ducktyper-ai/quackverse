...
def run_tool(
    ...
    Examples:
        ...
        ducktyper run quackmeta --help

        ducktyper run quackviz mydata.csv --format png
    """
    ...
    try:
        ...
        if is_playful_mode():
            ...
            if dance or cli_env.config.get_custom("ducktyper.always_dance", False):
