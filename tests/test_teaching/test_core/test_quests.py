# tests/test_teaching/test_core/test_quests.py
"""
Tests for the teaching utilities module.
...
class TestTeachingUtils:
    """Tests for teaching utility functions."""
    ...
    @patch("quackcore.teaching.core.utils.get_progress_file_path")
    @patch("quackcore.teaching.core.utils.fs.write_json")
    @patch("quackcore.teaching.core.utils.logger")
    ...
    @patch("quackcore.teaching.core.utils.get_user_data_dir")
    @patch("quackcore.teaching.core.utils.get_progress_file_path")
    @patch("quackcore.teaching.core.utils.fs.get_file_info")
    ...
    @patch("quackcore.teaching.core.utils.get_github_username")
    @patch("quackcore.teaching.core.utils.save_progress")
