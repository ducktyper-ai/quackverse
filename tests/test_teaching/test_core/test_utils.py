...
class TestGetProgressFilePath:
    ...
    def test_default_file_path(self, mock_fs):
        ...
        with patch("quackcore.teaching.core.utils.get_user_data_dir") as mock_get_dir:
...
class TestLoadProgress:
    ...
    def test_load_nonexistent_file(self, mock_fs, mock_logger):
        ...
        with patch(
            ...
            mock_fs.get_file_info.return_value = MagicMock(success=True, exists=False)
    ...
    def test_load_validation_error(self, mock_fs, mock_logger):
        ...
        with patch(
            ...
            mock_fs.read_json.return_value = MagicMock(success=True, data=invalid_data)
...
class TestSaveProgress:
    ...
    def test_save_progress_success(self, mock_fs, mock_logger):
        ...
        with patch(
            ...
            mock_fs.write_json.return_value = MagicMock(success=True)
    ...
    def test_save_progress_exception(self, mock_fs, mock_logger):
        ...
        with patch(
            ...
            mock_fs.write_json.side_effect = Exception("Unexpected error")
...
class TestCreateNewProgress:
    ...
    def test_create_new_progress(self):
        ...
        with patch(
            ...
            # Mock save_progress
            with patch("quackcore.teaching.core.utils.save_progress") as mock_save:
