...
from quackcore.teaching.npc.tools import utils
...
class TestToolUtils:
    ...
    def test_run_tools_basic(self, mocker):
        ...
        mock_registry = mocker.patch("quackcore.teaching.npc.tools.utils.TOOL_REGISTRY")
    ...
    def test_run_tools_missing_tool(self, mocker):
        ...
        mock_logger = mocker.patch("quackcore.teaching.npc.tools.utils.logger")
