...
from quackcore.teaching.npc.tools import certificate_tools
from quackcore.teaching.npc.tools.schema import CertificateListOutput
...
class TestCertificateTools:
    ...
    def test_get_certificate_info_no_certificates(
        ...
        mock_standardize = mocker.patch(
            "quackcore.teaching.npc.tools.certificate_tools.standardize_tool_output"
        )
