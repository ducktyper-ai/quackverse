...
from quackcore.teaching.npc.tools import tutorial_tools
...
class TestTutorialTools:
    ...
    def test_get_tutorial_basic(self, mocker):
        ...
        mock_standardize = mocker.patch(
            "quackcore.teaching.npc.tools.tutorial_tools.standardize_tool_output"
        )
    ...
    def test_get_tutorial_render_failure(self, mocker):
        ...
        # Mock logger
        mock_logger = mocker.patch("quackcore.teaching.npc.tools.tutorial_tools.logger")
