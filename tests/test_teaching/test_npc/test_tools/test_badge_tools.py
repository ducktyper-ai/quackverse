...
from quackcore.teaching.npc.tools import badge_tools
from quackcore.teaching.npc.tools.schema import BadgeDetailOutput, BadgeListOutput
...
class TestBadgeTools:
    ...
    def test_list_badges(self, mocker, mock_user, user_memory):
        ...
        # Mock dependencies
        mock_utils = mocker.patch("quackcore.teaching.npc.tools.badge_tools.utils")
        mock_utils.load_progress.return_value = mock_user

        mock_badges = mocker.patch("quackcore.teaching.npc.tools.badge_tools.badges")
        ...
        mock_standardize = mocker.patch(
            "quackcore.teaching.npc.tools.badge_tools.standardize_tool_output"
        )
    ...
    def test_get_badge_details(self, mocker, mock_user, mock_badge):
        ...
        mock_rag = mocker.patch("quackcore.teaching.npc.tools.badge_tools.rag")
    ...
    def test_get_badge_details_render_failure(self, mocker, mock_user, mock_badge):
        ...
        # Mock logger
        mock_logger = mocker.patch("quackcore.teaching.npc.tools.badge_tools.logger")
