# tests/quackcore/test_integrations/google/mail/_operations/test_email.py
"""
...
class TestGmailEmailOperations:
    ...
    def test_build_query(self) -> None:
        ...
        # Test with days_back
        with patch(
            "quackcore.integrations.google.mail._operations.email.datetime"
        ) as mock_dt:
    ...
    def test_list_emails(self, mock_gmail_service) -> None:
        ...
        with patch(
            "quackcore.integrations.google.mail._operations.email.execute_api_request",
    ...
    def test_get_message_with_retry(self, mock_gmail_service) -> None:
        ...
        with patch(
            ...
            with patch(
                "quackcore.integrations.google.mail._operations.email.time.sleep"
            ) as mock_sleep:
                message = email._get_message_with_retry(
                    mock_gmail_service, "me", "msg1", 3, 0.1, 0.5, logger
                )
    ...
    @patch("quackcore.integrations.google.mail._operations.email.process_message_parts")
    @patch(
        "quackcore.integrations.google.mail._operations.email._get_message_with_retry"
    )
    def test_download_email(
        ...
        with (
            ...
            patch(
                "quackcore.integrations.google.mail._operations.email.clean_filename"
            ) as mock_clean,
            patch("quackcore.integrations.google.mail._operations.email.fs") as mock_fs,
        ):
