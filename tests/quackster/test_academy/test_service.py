# tests/quackster/test_academy/test_service.py
"""
...
class TestTeachingService:
    ...
    def test_initialize_error(self, mock_fs, mock_resolver):
        ...
        with patch(
            ...
            assert "Failed to initialize quackster service" in result.message
    ...
    def test_create_context_error(self, mock_fs, mock_resolver):
        ...
        with patch(
            ...
            # Verify the result
            assert not result.success
            assert "Failed to create quackster context" in result.message
