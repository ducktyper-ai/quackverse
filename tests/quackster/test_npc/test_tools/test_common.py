# tests/quackster/test_npc/test_tools/test_common.py
"""
Tests for the common utilities in quackster.npc.tools.common.
...
class TestStandardizeToolOutput:
    ...
    def test_basic_functionality(self, mocker):
        ...
        mock_registry = mocker.patch("quackster.npc.tools.common.DialogueRegistry")
