# tests/quackster/test_core/test_certificates.py
"""
Tests for the quackster certificates module.

This module tests the certificate functionality in quackster.core.certificates.
"""
...
from quackster.core import certificates
...
class TestCertificates:
    ...
    @patch("quackster.core.certificates.time")
    @patch("quackster.core.certificates.datetime")
    @patch("quackster.core.certificates.logger")
    @patch("quackster.core.certificates._sign_certificate")
    def test_create_certificate(self, mock_sign, mock_logger, mock_datetime, mock_time):
        ...
        with patch(
            "quackster.core.certificates.GamificationService",
    ...
    @patch("quackster.core.certificates.hmac")
