...
"""
Tests for the quackster XP management module.

This module tests the XP management functionality in quackster.core.xp.
"""

from unittest.mock import MagicMock, patch

from quackster.core import xp
...
class TestXPManagement:
    ...
    @patch("quackster.core.xp.badges.get_all_badges")
    @patch("quackster.core.xp.logger")
    ...
    @patch("quackster.core.xp.badges.get_all_badges")
    @patch("quackster.core.xp.logger")
    @patch("quackster.core.xp._handle_level_up")
    ...
    def test_add_xp_from_quest(self, mock_logger):
        ...
        with patch("quackster.core.xp.add_xp") as mock_add_xp:
            # Act
    ...
    def test_handle_level_up(self):
        ...
        with patch("quackster.core.xp._check_level_badges") as mock_check:
            # Act
    ...
    @patch("quackster.core.xp.badges.get_badge")
    @patch("quackster.core.xp.logger")
