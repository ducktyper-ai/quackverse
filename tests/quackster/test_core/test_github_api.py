# tests/quackster/test_core/test_github_api.py
"""
Tests for the quackster GitHub API integration.

This module tests the GitHub API utility functions in quackster.core.github_api.
"""

from unittest.mock import MagicMock, patch

from quackster.core import github_api


class TestGitHubAPI:
    """Tests for GitHub API integration functions."""

    @patch("quackster.core.github_api.registry")
    @patch("quackster.core.github_api.logger")
    ...
    @patch("quackster.core.github_api._get_github_client")
    @patch("quackster.core.github_api.logger")
