...
This module tests the GitHub grading functionality in quackster.github.grading.
"""
...
class TestGitHubGrader:
    ...
    @patch("quackster.github.grading.GamificationService")
    ...
    def test_grade_submission_custom_criteria(
        ...
        # Act
        with patch("quackster.github.grading.GamificationService"):
