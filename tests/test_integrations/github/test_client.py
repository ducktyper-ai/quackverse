...
class TestGitHubClient:
    ...
    def test_get_user_authenticated(self, github_client):
        ...
        with patch("quackcore.integrations.github.client.get_user") as mock_get_user:
            user = GitHubUser(
                username="test_user",
    ...
    def test_get_repo(self, github_client):
        ...
        with patch("quackcore.integrations.github.client.get_repo") as mock_get_repo:
            owner = GitHubUser(
    ...
    def test_star_repo(self, github_client):
        ...
        with patch("quackcore.integrations.github.client.star_repo") as mock_star_repo:
    ...
    def test_unstar_repo(self, github_client):
        ...
        with patch(
            "quackcore.integrations.github.client.unstar_repo"
        ) as mock_unstar_repo:
    ...
    def test_is_repo_starred(self, github_client):
        ...
        with patch(
            "quackcore.integrations.github.client.is_repo_starred"
        ) as mock_is_starred:
    ...
    def test_fork_repo(self, github_client):
        ...
        with patch("quackcore.integrations.github.client.fork_repo") as mock_fork_repo:
    ...
    def test_create_pull_request(self, github_client):
        ...
        with patch(
            "quackcore.integrations.github.client.create_pull_request"
        ) as mock_create_pr:
            author = GitHubUser(
    ...
    def test_list_pull_requests(self, github_client):
        ...
        with patch(
            "quackcore.integrations.github.client.list_pull_requests"
        ) as mock_list_prs:
            author = GitHubUser(
                username="test_user", url="https://github.com/test_user"
            )
    ...
    def test_get_pull_request(self, github_client):
        ...
        with patch(
            "quackcore.integrations.github.client.get_pull_request"
        ) as mock_get_pr:
            author = GitHubUser(
                username="test_user", url="https://github.com/test_user"
            )
    ...
    def test_check_repository_exists(self, github_client):
        ...
        with patch(
            "quackcore.integrations.github.client.check_repository_exists"
        ) as mock_check:
    ...
    def test_get_repository_file_content(self, github_client):
        ...
        with patch(
            "quackcore.integrations.github.client.get_repository_file_content"
        ) as mock_get_content:
    ...
    def test_update_repository_file(self, github_client):
        ...
        with patch(
            "quackcore.integrations.github.client.update_repository_file"
        ) as mock_update:
    ...
    def test_create_issue(self, github_client):
        ...
        with patch("quackcore.integrations.github.client.create_issue") as mock_create:
    ...
    def test_list_issues(self, github_client):
        ...
        with patch("quackcore.integrations.github.client.list_issues") as mock_list:
    ...
    def test_get_issue(self, github_client):
        ...
        with patch("quackcore.integrations.github.client.get_issue") as mock_get:
    ...
    def test_add_issue_comment(self, github_client):
        ...
        with patch(
            "quackcore.integrations.github.client.add_issue_comment"
        ) as mock_add:
    ...
    def test_get_pull_request_files(self, github_client):
        ...
        with patch(
            "quackcore.integrations.github.client.get_pull_request_files"
        ) as mock_get:
