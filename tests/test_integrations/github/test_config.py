# tests/test_integrations/github/test_config.py
...
class TestGitHubConfigProvider:
    ...
    def test_get_default_config(self, config_provider):
        ...
        assert "teaching" in default_config

        # Check teaching config
        teaching_config = default_config["teaching"]
    ...
    def test_extract_config_fallback(self, config_provider):
        ...
        with patch(
            "quackcore.integrations.core.BaseConfigProvider._extract_config"
        ) as mock_super:
    ...
    def test_load_config_with_env_token(self, config_provider):
        ...
        with patch(
            "quackcore.integrations.core.BaseConfigProvider.load_config"
        ) as mock_super:
