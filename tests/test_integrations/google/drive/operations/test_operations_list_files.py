# tests/test_integrations/google/drive/operations/test_operations_list_files.py
"""
...
class TestDriveOperationsListFiles:
    ...
    def test_list_files(self) -> None:
        ...
        with patch(
            ...
            with patch(
                "quackcore.integrations.google.drive.utils.query.build_query"
            ) as mock_query:
    ...
    def test_list_files_with_model_conversion(self) -> None:
        ...
        with patch(
            ...
            with patch("quackcore.integrations.google.drive.utils.query.build_query"):
                # Call the function
                result = list_files.list_files(mock_drive_service)
